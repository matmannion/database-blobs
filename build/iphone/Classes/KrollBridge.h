...
@interface database_blobsObject : KrollCoverageObject {
#else
@interface database_blobsObject : KrollObject {
#endif
@private
...
extern NSString * database_blobs$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	database_blobsObject *_database_blobs;
	BOOL shutdown;
