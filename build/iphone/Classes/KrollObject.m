 ...
 * Copyright (c) 2009-2011 by database_blobs, Inc. All Rights Reserved.
...
//@interface database_blobsObject : NSObject
//@end

@interface database_blobsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[database_blobsObject class]])
		{
			for (NSString *key in [[(database_blobsObject*)o modules] allKeys])
			{
