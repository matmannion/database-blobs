...
// in simulator we redefine to format for database_blobs Developer console
...
{\
	NSString * exceptionName = [@"org.database_blobs." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.database_blobs";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIdatabase_blobsNativeItemNone = -1, 
	UIdatabase_blobsNativeItemSpinner = -2,
	UIdatabase_blobsNativeItemProgressBar = -3,
	
	UIdatabase_blobsNativeItemSlider = -4,
	UIdatabase_blobsNativeItemSwitch = -5,
	UIdatabase_blobsNativeItemMultiButton = -6,
	UIdatabase_blobsNativeItemSegmented = -7,
	
	UIdatabase_blobsNativeItemTextView = -8,
	UIdatabase_blobsNativeItemTextField = -9,
	UIdatabase_blobsNativeItemSearchBar = -10,
	
	UIdatabase_blobsNativeItemPicker = -11,
	UIdatabase_blobsNativeItemDatePicker = -12,
	
	UIdatabase_blobsNativeItemInfoLight = -13,
	UIdatabase_blobsNativeItemInfoDark = -14,
	
	UIdatabase_blobsNativeItemDisclosure = -15,
	
	UIdatabase_blobsNativeItemContactAdd = -16
};
